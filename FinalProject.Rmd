...
almshouse.outcomes.graph %>%
  ...
  ggplot(aes(fill=Category, y=percentage, x=Reason.for.Discharge)) + 
    ...
    labs(x = "Reason for Discharge", y = "Percentage of Category", title = "Inmate Outcomes by Category")
```
