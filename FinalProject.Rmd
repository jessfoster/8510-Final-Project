...
almshouse_admissions <- almshouse_admissions %>%
   mutate(Race = case_when(Descriptions.by.Clerk %in% black.descriptors ~ "Black",
                           ...
                           !Descriptions.by.Clerk %in% black.descriptors | Descriptions.by.Clerk %in% mulatto.descriptors ~ "NA")) # If code doesn't match list for "black" or "mulatto", assign NA
...
```{r Percentage of Black Inmates, include=FALSE}
# How many inmates like Sarah and Ann Bordley were black?

# Create subset of black inmates
almshouse_admissions_black <- almshouse_admissions %>%
  filter(Race == "Black")

# Calculate percentage of black inmates in sample of 1400
almshouse_admissions_black %>%
  summarize(count = n()) %>%
  mutate(percentage =  100*count/1400)

# 133 inmates, or 9.5 percent, were black
```

Sarah and Ann Bordley were not the only free blacks who spent time in the Philadelphia Almshouse during this period. Of a sample of 1400 individuals admitted between 1796 and 1803, one hundred and thirty-three, or 9.5 percent, were described by the almshouse clerk as "black."[^3] Scholars such as Gary B. Nash have pointed to the small percentage of black inmates in the almshouse as an indication of the relative success of black Philadelphians "in securing employment and launching independent businesses," especially when compared to Irish immigrants.[^4] While most poor blacks avoided a stay in the almshouse, a closer look at the data reveals that those who did apply for relief suffered a much higher percentage of deaths than other inmates. Based on a quantitative study of inmate outcomes, I argue that, for many poor blacks, the Philadelphia Almshouse was not a temporary shelter but a place of death: the last stop in a long road of struggle against poverty, disease, and racism.  
...
While the almshouse never held more than the most destitute of Philadelphia’s poor, the racial composition of its inmate population was fairly representative of the city’s population as a whole. As noted above, black inmates made up 9.5 percent of the almshouse population in the 1796-1803 sample. These numbers indicate only a slight overrepresentation: blacks (free and enslaved) made up 9.2 percent of the population of Philadelphia in 1800.[^6] The pie charts below show, on the left, a percentage breakdown of the five most common inmate descriptions, and, on the right, a percentage breakdown of the various inmate descriptions that I have grouped under the term "black."[^7]
...
ENTRIES, 1800–1804," *Pennsylvania History: A Journal of Mid-Atlantic Studies* 52, no. 3 (July 1985): 192, https://www.jstor.org/stable/27773054. See also Billy G. Smith, *The "Lower Sort": Philadelphia’s Laboring People, 1750-1800* (Ithaca, NY: Cornell University Press, 1990), 196.
...
[^4]: Nash, *Forging Freedom*, 154, 155-156.
[^5]: John K. Alexander, *Render Them Submissive: Responses to Poverty in Philadelphia, 1760-1800* (Amherst: University of Massachusetts Press, 1980), 88-89; Billy G. Smith, *Life in Early Philadelphia: Documents from the Revolutionary and Early National Periods* (University Park, PA: Pennsylvania State University Press, 1995), 30.
[^6]: Nash, *Forging Freedom*, 143.
[^7]: In contrast to Gary B. Nash, I have chosen not to include inmates described as "mulatto" under the term "black," unless the description reads "black or mulatto," in which case I did include them under "black." The grouping of black and mulatto inmates does not alter the conclusions I have drawn.
---
### Bibliography
